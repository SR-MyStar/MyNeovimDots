local function custom_highlights(C)
    ...
    highlights.DropBarIconKindDeclaration =
        reverse(highlights.CmpItemKindSnippet)
    highlights.DropBarIconKindIdentifier =
        reverse(highlights.CmpItemKindVariable)
    ...
    highlights.DropBarIconKindInterface =
        reverse(highlights.CmpItemKindInterface)
    highlights.DropBarIconKindColor = reverse(highlights.CmpItemKindColor)
    highlights.DropBarIconKindReference =
        reverse(highlights.CmpItemKindReference)
