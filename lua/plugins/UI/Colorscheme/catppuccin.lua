local function custom_highlights(C)
    ...
    local highlights                        = {
        ...
        TelescopePromptTitle     = { fg = is(C.red, C.base), bg = is(C.none, C.red) },
        TelescopePromptBorder    = { fg = is(C.none, C.red), bg = is(C.red, C.base) },
        ...
        TelescopePreviewBorder   = { fg = is(C.none, C.green), bg = is(C.green, C.base) },
        TelescopePreviewTitle    = { fg = is(C.green, C.base), bg = is(C.none, C.green) },
        TelescopeSelection       = { fg = is(C.red, C.text), bg = is(C.none, C.base), style = { "bold" } },
